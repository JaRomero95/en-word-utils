...
const urls = [
  {
    constructUrl: (value: string) => `https://www.google.com/search?q=%22${value}%22`,
    name: 'Google exact search',
    img: ImageGoogle
  },
  {
    constructUrl: (value: string) => `https://dictionary.cambridge.org/dictionary/english/${value}`,
    name: 'Cambridge dictionary',
    img: ImageCambridge
  },
  {
    constructUrl: (value: string) => `https://www.ldoceonline.com/dictionary/${value}`,
    name: 'Longman dictionary',
    img: ImageLongman
  },
  {
    constructUrl: (value: string) => `https://www.thesaurus.com/browse/${value}`,
    name: 'Thesaurus synonyms',
    img: ImageThesaurus
  },
  {
    constructUrl: (value: string) => `https://es.youglish.com/pronounce/${value}/english?`,
    name: 'YouGlish',
    img: ImageYouglish
  },
  {
    constructUrl: (value: string) => `https://www.ingles.com/pronunciacion/${value}`,
  ...
  return (
    <div id="main">
      ...
      <form onSubmit={onSubmit}>
        <input type="text" value={value} onChange={event => onChange(event, setValue)} />
